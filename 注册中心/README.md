...
* [1. 注册中⼼需要提供哪些API接口](#1-注册中⼼需要提供哪些API接口)
* [2. 该如何部署](#2-如何部署)
* [3. 如何存储服务信息](#3-如何存储服务信息)
* [4. 如何监控服务提供者节点的存活](#4-如何监控服务提供者节点的存活)
* [5. 如果服务提供者节点有变化如何通知服务消费者](#5-如果服务提供者节点有变化如何通知服务消费者)
* [6. 以及如何控制注册中⼼的访问权限](#6-以及如何控制注册中⼼的访问权限)
